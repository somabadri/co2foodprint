...
class About extends Component {
    render() {
        ...
        let kelley='I am a 3rd year majoring in Computer Science and Math. I wanted to help create this app bc I am interested in eco-conservation stuff and thought it would be useful. My fun fact is I am on a mission to pet every cat in my neighborhood';
        let raymond='I am a 3rd year Computer Science major and I wanted to create this app because I wanted to personally track my own carbon emissions.';
        let destin ='I am a 3rd year Computer Science major at UCSC. I wanted to make this app because I want to help spread environmental awareness. I like walking my two dogs Oreo and Charlie, and ice skating.';
        return (
        <div>
            <Navbar />
