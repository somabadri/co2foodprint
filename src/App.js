...
function CalculateFood(props) {
  const {
    ...
    profile,
    text16,
    baseline_Fastfood_White_48Dp1,
    baseline_Directions_Car_White_48Dp1,
    food,
    transportation,
    quantity,
    item,
      ...
      <div className="calculate-food screen">
        ...
        <div className="flex-row-4">
          <div className="overlap-group">
            <img className="baseline" src={baseline_Fastfood_White_48Dp1} />
          </div>
          <div className="overlap-group3">
            <img className="baseline" src={baseline_Directions_Car_White_48Dp1} />
          </div>
        </div>
        ...
        <div className="flex-row-6">
          <div className="overlap-group5">
            <div className="submit lato-bold-white-30px">{submit}</div>
          </div>
          <div className="overlap-group6">
            <div className="cancel lato-bold-white-30px">{cancel}</div>
          </div>
        </div>
